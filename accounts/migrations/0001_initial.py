    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=255, unique=True)),
                ('last_name', models.CharField(blank=True, max_length=255, unique=True)),
                ('confirm_password', models.CharField(max_length=255, unique=True)),
                ('learning_goal', models.CharField(blank=True, max_length=255, unique=True)),
